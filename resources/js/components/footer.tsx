...
import { Heart, Mail, Minus } from 'lucide-react';
                ...
                <div className="mb-8 grid grid-cols-1 gap-8 md:grid-cols-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm leading-relaxed text-muted-foreground">
                            Notre plateforme vous connecte aux opportunités d’emploi et aux activités de recrutement proposées par l’entreprise.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="mailto:contact@job-horizon.com" className="rounded-lg bg-muted p-2 transition-colors hover:bg-muted/80">
